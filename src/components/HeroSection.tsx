...
const HeroSection = () => {
  ...
  return (
    <section 
      ...
      ref={heroRef}
      style={{
        backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.6)), url('https://images.unsplash.com/photo-1551038247-3d9af20df552?w=1920&h=1080&fit=crop&crop=center')`,
          ...
          <div ref={contentRef} className="text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              ...
              <Button 
                variant="outline" 
                size="lg" 
                className="border-2 border-white text-white hover:bg-white hover:text-marketing-green px-8 py-4 rounded-lg text-lg font-semibold transition-all duration-300 backdrop-blur-sm" 
          ...
          <div ref={imageRef}>
            <div className="relative">
              ...
              <img 
                ...
                className="relative z-10 w-full h-[400px] object-cover rounded-2xl shadow-2xl border border-white/10" 
              />
