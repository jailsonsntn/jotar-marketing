        ...
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <button
              ...
              className="text-gray-700 hover:text-marketing-orange transition-colors duration-300"
            >
              Início
            </button>
            <button
          ...
          <div className="hidden md:block">
            <Button 
              ...
              onClick={() => window.open('https://wa.me/+5513985994965?text=Olá! Gostaria de solicitar uma cotação para serviços de marketing digital.', '_blank')}
            >
              Fale Conosco
            </Button>
          </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-4 pb-4 border-t border-gray-100">
            <nav className="flex flex-col space-y-4 pt-4">
              <button
                onClick={() => scrollToSection('inicio')}
                className="text-left text-gray-700 hover:text-marketing-orange transition-colors duration-300"
              >
                Início
              </button>
              <button
