...
const Footer = () => {
  ...
  return (
    <footer className="bg-marketing-green text-white">
      {/* Main Footer Content */}
          ...
          <div>
            ...
            <div className="flex mb-6">
              <input 
                ...
                className="flex-1 px-3 py-2 bg-white/10 rounded-l-lg border border-white/20 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-marketing-orange"
              />
            ...
            <ul className="space-y-2">
              {footerLinks.support.slice(0, 3).map((item, index) => (
                <li key={index}>
            ...
            <div className="mb-4 md:mb-0">
              ...
              <div className="flex space-x-4">
                {paymentMethods.map((method, index) => (
                  <div 
                    key={index}
                    className="w-12 h-8 bg-white/10 rounded flex items-center justify-center text-sm hover:bg-white/20 transition-colors duration-300"
                  >
                    {method.icon}
                  </div>
                ))}
      ...
      <button 
        ...
        onClick={() => window.open('https://wa.me/5511999999999?text=Olá! Vim através do site e gostaria de falar sobre marketing digital.', '_blank')}
